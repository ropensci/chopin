...
testthat::test_that("vector validity check is cleared", {
  ...
  expect_no_error(validate_and_repair_vectors(nc))

  nct <- terra::vect(nc)
  expect_no_error(validate_and_repair_vectors(nct))
})
...
testthat::test_that("Clip by extent works without errors", {
  ...
  expect_no_error(clip_as_extent_ras(ncp, 30000L, ncelev))
  expect_no_error(clip_as_extent_ras(ncp_terra, 30000L, ncelev))
...
testthat::test_that("Grid split is well done.", {
  ...
  expect_no_error(get_computational_regions(nc, mode = "grid"))
  ncgrid <- get_computational_regions(nc, mode = "grid")
  expect_s3_class(ncgrid, "sf")

  nctr <- terra::vect(nc)
  expect_no_error(get_computational_regions(nctr, mode = "grid"))
  ncgridtr <- get_computational_regions(nctr, mode = "grid")
  expect_s4_class(ncgridtr, "SpatVector")
...
testthat::test_that("Check bbox abides.", {
  ...
  expect_no_error(check_bbox(ncp, nc))
