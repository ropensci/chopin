...
#>   `/tmp/RtmpojIQ92/temp_libpath7a5b3e1edd2b/chopin/extdata/nc_hierarchy.gpkg' 
#>   using driver `GPKG'
...
testfiles
#> [1] "/tmp/RtmpFqVU5V/test1.tif" "/tmp/RtmpFqVU5V/test2.tif"
#> [3] "/tmp/RtmpFqVU5V/test3.tif" "/tmp/RtmpFqVU5V/test4.tif"
#> [5] "/tmp/RtmpFqVU5V/test5.tif"
```
...
#> ℹ Input is not a character.
#> Input is a character. Attempt to read it with terra::rast...
#> ℹ Your input function at /tmp/RtmpFqVU5V/test1.tif is dispatched.
#> 
#> Input is a character. Attempt to read it with terra::rast...
#> ℹ Your input function at /tmp/RtmpFqVU5V/test2.tif is dispatched.
#> 
#> Input is a character. Attempt to read it with terra::rast...
#> ℹ Your input function at /tmp/RtmpFqVU5V/test3.tif is dispatched.
#> 
#> Input is a character. Attempt to read it with terra::rast...
#> ℹ Your input function at /tmp/RtmpFqVU5V/test4.tif is dispatched.
#> 
#> Input is a character. Attempt to read it with terra::rast...
#> ℹ Your input function at /tmp/RtmpFqVU5V/test5.tif is dispatched.
#>    user  system elapsed 
#>   1.488   1.452   3.569
...
|      mean | base_raster               |
|----------:|:--------------------------|
| 136.80203 | /tmp/RtmpFqVU5V/test1.tif |
| 189.76170 | /tmp/RtmpFqVU5V/test1.tif |
| 231.16968 | /tmp/RtmpFqVU5V/test1.tif |
|  98.03845 | /tmp/RtmpFqVU5V/test1.tif |
|  41.23463 | /tmp/RtmpFqVU5V/test1.tif |
| 270.96933 | /tmp/RtmpFqVU5V/test1.tif |
...
#>   `/tmp/RtmpojIQ92/temp_libpath7a5b3e1edd2b/chopin/extdata/ncroads_first.gpkg' 
#>   using driver `GPKG'
...
#> Writing layer `pntst' to data source `/tmp/RtmpFqVU5V/pntst.gpkg' using driver `GPKG'
