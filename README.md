...
- `chopin` can be installed using `pak::pak`, `devtools::install_github`, or `remotes::install_github`.
    - All required and suggested packages for `chopin` are installed if `dependencies` argument is set `TRUE`. Dependencies include the required packages to run examples below.

```r
# install.packages("devtools")
devtools::install_github(
  "Spatiotemporal-Exposures-and-Toxicology/chopin",
  dependencies = TRUE
)
```
```r
...
<div class="figure">
<img src="man/figures/README-read-nc-1.png" alt="plot of chunk read-nc" width="100%" />
<p class="caption">plot of chunk read-nc</p>
</div>
...
<div class="figure">
<img src="man/figures/README-gen-ncpoints-1.png" alt="plot of chunk gen-ncpoints" width="100%" />
<p class="caption">plot of chunk gen-ncpoints</p>
</div>
...
```r
# data preparation
wdir <- testthat::test_path("../testdata")
...
#> max value   :         1946.400
plot(srtm)
#> Error in .External.graphics(C_plotXY, xy, t, pch, lty, col, bg, cex, lwd, : invalid type passed to graphics function
```

<div class="figure">
<img src="man/figures/README-load-srtm-1.png" alt="plot of chunk load-srtm" width="100%" />
<p class="caption">plot of chunk load-srtm</p>
</div>
...
<div class="figure">
<img src="man/figures/README-plot results-1.png" alt="plot of chunk plot results" width="100%" />
<p class="caption">plot of chunk plot results</p>
</div>
...
<div class="figure">
<img src="man/figures/README-plot results-2.png" alt="plot of chunk plot results" width="100%" />
<p class="caption">plot of chunk plot results</p>
</div>
...
#>   `/home/felix/GitHub/chopin/tests/testdata/nc_hierarchy.gpkg' 
#>   using driver `GPKG'
...
testfiles
#> [1] "/tmp/RtmpQYZysV/test1.tif" "/tmp/RtmpQYZysV/test2.tif"
#> [3] "/tmp/RtmpQYZysV/test3.tif" "/tmp/RtmpQYZysV/test4.tif"
#> [5] "/tmp/RtmpQYZysV/test5.tif"
```
...
|:-----|---------:|:-------------------------|
|37037 | 136.80203|/tmp/RtmpQYZysV/test1.tif |
|37001 | 189.76170|/tmp/RtmpQYZysV/test1.tif |
|37057 | 231.16968|/tmp/RtmpQYZysV/test1.tif |
|37069 |  98.03845|/tmp/RtmpQYZysV/test1.tif |
|37155 |  41.23463|/tmp/RtmpQYZysV/test1.tif |
|37109 | 270.96933|/tmp/RtmpQYZysV/test1.tif |
...
#> Error in par_grid(grids = nccompreg, fun_dist = terra::nearest, x = pnts, : could not find function "par_grid"
...
#> Error in eval(expr, envir, enclos): object 'resj' not found
```
