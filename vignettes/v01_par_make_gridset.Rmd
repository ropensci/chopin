...
<div class="figure">
<img src="figures/nc-gen-points-1.png" alt="plot of chunk nc-gen-points" width="900px" />
...
<div class="figure">
<img src="figures/nc-gen-points-2.png" alt="plot of chunk nc-gen-points" width="900px" />
<p class="caption">plot of chunk nc-gen-points</p>
</div>
...
<div class="figure">
<img src="figures/compare-compregions-1.png" alt="plot of chunk compare-compregions" width="900px" />
...
<div class="figure">
<img src="figures/compare-compregions-2.png" alt="plot of chunk compare-compregions" width="900px" />
<p class="caption">plot of chunk compare-compregions</p>
</div>
...
par(mfrow = c(1, 1))
terra::plot(grid_qunatiles$original, main = "Original grids")
```

```
## Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'grid_qunatiles' not found
```
...
par(mfrow = c(1, 1))
terra::plot(grid_qunatiles$original, main = "Merged grids (merge_max = 5)")
```
...
<div class="figure">
<img src="figure/unnamed-chunk-2-1.png" alt="plot of chunk unnamed-chunk-2" width="900px" />
