...
- Single-node calculation: as of version 0.3.0, `chopin`, functions were tested in a single-node environment. Users should consider using `chopin` in a multi-node environment with caution.
