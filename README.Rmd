...
From version 0.9.5, `chopin` supports [H3](https://h3geo.org/) and [DGGRID](https://github.com/sahrk/DGGRID) in `par_pad_grid()`. Users can utilize each grid system with a proper resolution to improve the efficiency of spatial operations.
