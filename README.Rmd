...
pkgs <- c("chopin", "dplyr", "sf", "terra", "future", "mirai")
...
# backend parallel processor: default is "mirai"
...
# reproject
pntst <- terra::project(pnts, "EPSG:5070")
rd1t <- terra::project(rd1, "EPSG:5070")
...
# terra::nearest run
system.time(
  restr <- terra::nearest(x = pntst, y = rd1t)
)
