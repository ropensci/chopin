...
```{r vig3, eval = FALSE}
litr::add_vignettes("../tools/vignettes-sources/v02_par_functions.Rmd")
```
...
```{r, eval = FALSE, include = FALSE}
  ...
  #     run_result <- tryCatch({
  #       kk <- chopin::extract_at_buffer(ncpnts, ncelev, 30000L, "pid", grid_ref = x)
  #       #fun(...)
  #       #print(xx)
  ...
  # chopin::extract_at_buffer(ncpnts, ncelev, 30000L, "pid", grid_ref = nccompreg %>% split(., .$CGRIDID) %>% .[[5]])
```
