...
usethis::create_package(
  ...
  fields = list(
    ...
    Depends = "R (>= 4.1)",
    URL = "https://github.com/Spatiotemporal-Exposures-and-Toxicology/Scalable_GIS",
    BugReports = "https://github.com/Spatiotemporal-Exposures-and-Toxicology/Scalable_GIS/issues"
  )
)
...
```{r vig3, eval = TRUE}
litr::add_vignettes("../tools/vignettes-sources/v02_par_function_example.Rmd")
```
