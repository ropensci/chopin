...
- The standard sequence of running `par_grid()` includes the following steps:
    1. Generate computational grids with `par_pad_grid()` or `par_group_grid()`. This step will give you a set of grid polygons, one of which is original splits and the other is padded in consideration of buffer radius in the subsequent spatial operations.
...
<div class="figure">
<img src="vignettes/figures/nc-gen-points-1.png" alt="plot of chunk nc-gen-points" width="600px" />
...
<div class="figure">
<img src="vignettes/figures/nc-gen-points-2.png" alt="plot of chunk nc-gen-points" width="600px" />
<p class="caption">plot of chunk nc-gen-points</p>
</div>
...
<div class="figure">
<img src="vignettes/figures/grid-plain-1.png" alt="plot of chunk grid-plain" width="600px" />
...
<div class="figure">
<img src="vignettes/figures/compare-compregions-1.png" alt="plot of chunk compare-compregions" width="600px" />
...
<div class="figure">
<img src="vignettes/figures/compare-compregions-2.png" alt="plot of chunk compare-compregions" width="600px" />
<p class="caption">plot of chunk compare-compregions</p>
</div>
...
<div class="figure">
<img src="vignettes/figures/split-points-grid-1.png" alt="plot of chunk split-points-grid" width="600px" />
...
<div class="figure">
<img src="vignettes/figures/split-points-grid-2.png" alt="plot of chunk split-points-grid" width="600px" />
<p class="caption">plot of chunk split-points-grid</p>
</div>
...
<div class="figure">
<img src="vignettes/figures/split-points-grid-adv-1.png" alt="plot of chunk split-points-grid-adv" width="600px" />
...
<div class="figure">
<img src="vignettes/figures/split-points-grid-adv-2.png" alt="plot of chunk split-points-grid-adv" width="600px" />
<p class="caption">plot of chunk split-points-grid-adv</p>
</div>
...
<div class="figure">
<img src="vignettes/figures/split-points-count-1.png" alt="plot of chunk split-points-count" width="600px" />
<p class="caption">plot of chunk split-points-count</p>
</div>
...
<div class="figure">
<img src="vignettes/figures/split-points-grid-adv2-1.png" alt="plot of chunk split-points-grid-adv2" width="600px" />
...
<div class="figure">
<img src="vignettes/figures/split-points-grid-adv2-2.png" alt="plot of chunk split-points-grid-adv2" width="600px" />
<p class="caption">plot of chunk split-points-grid-adv2</p>
</div>
...
<div class="figure">
<img src="vignettes/figures/split-points-grid-adv3-1.png" alt="plot of chunk split-points-grid-adv3" width="600px" />
<p class="caption">plot of chunk split-points-grid-adv3</p>
</div>
...
<div class="figure">
<img src="vignettes/figures/split-points-grid-adv3-2.png" alt="plot of chunk split-points-grid-adv3" width="600px" />
<p class="caption">plot of chunk split-points-grid-adv3</p>
</div>
...
- `par_group_grid()` makes a compatible object to the output of `par_pad_grid()` directly from the input points.
...
<div class="figure">
<img src="vignettes/figures/par-group-balanced-1.png" alt="plot of chunk par-group-balanced" width="600px" />
<p class="caption">plot of chunk par-group-balanced</p>
</div>
