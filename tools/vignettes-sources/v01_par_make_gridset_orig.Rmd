...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, out.width = "600px",
  fig.path = "vignettes/figures/", fig.lp = "")
# knitr::fig_path(".png", options = list(fig.path = "vignettes/figures/v01-"))
```
